...
@NgModule({
    imports: [RouterModule.forChild([
        ...
        { path: 'student/addstudent', data: { breadcrumb: 'student/addstudent' }, loadChildren: () => import('./../add-student/add-student.module').then(m => m.AddStudentModule) },
        { path: 'instructor', data: { breadcrumb: 'instructor' }, loadChildren: () => import('./../instructor/instrcutor.module').then(m => m.InstrcutorModule) },
        { path: 'subadmin', data: { breadcrumb: 'subadmin' }, loadChildren: () => import('./../subadmin/subadmin.module').then(m => m.SubadminModule) },
