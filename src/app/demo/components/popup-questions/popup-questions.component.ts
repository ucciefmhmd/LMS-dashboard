...
@Component({
    ...
    styleUrl: './popup-questions.component.scss',
})
export class PopupQuestionsComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private dialogRef: MatDialogRef<PopupQuestionsComponent>,
        ...
        this.actRoute.params.subscribe((params) => {
            ...
            if (id !== 0) {
                this.quesServices.getById(id).subscribe((ques: IQuestion) => {
                    ...
                    const selectsNumber = this.numOfQuestions.length;
